...
io.on('connection', function (socket) {
    ...
    socket.on("message", (message) => __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            var chat = new Messages_1.default(message);
            yield chat.save();
        }
        catch (error) {
            console.error(error);
...
app.get("/test", apiController.getApis);
app.get("/chat/:userid", apiController.getChat);
...
app.get("/getDetail", userController.getReset);
